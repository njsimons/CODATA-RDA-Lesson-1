...
The DOI itself is an alphanumberic character sequence, written in a standardized syntax, that when communicated as a URL redirects to a web landing page for the information resource 
